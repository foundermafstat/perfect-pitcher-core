...
const toolDefinitions = {
    ...
    changeBackgroundColor: {
        description: 'Switches between light and dark theme of the application', 
        parameters: {}
    },
    partyMode: {
    ...
    listTasks: {
        description: 'List tasks from the database',
        parameters: {}
    },
    updateTask: {
    ...
    // Агента снабдить контекстом выбранного проекта
    getAgentProjectContext: {
        description: 'Fetch agent context string for a project by id',
        parameters: {
    ...
    navigateToPage: {
        ...
        parameters: {
            page: {
                type: 'string',
                description: 'The page to navigate to. Available pages: home, my-stories, stories, projects, products, editor, agent, dashboard, charts, forms, ui, account, login, help',
                enum: ['home', 'my-stories', 'stories', 'projects', 'products', 'editor', 'agent', 'dashboard', 'charts', 'forms', 'ui', 'account', 'login', 'help']
            },
            reason: {
                type: 'string',
    ...
    // Команды управления презентацией
    nextSlide: {
        description: 'Go to the next slide in the presentation. Only works on presentation pages.',
        parameters: {}
    },
    previousSlide: {
        description: 'Go to the previous slide in the presentation. Only works on presentation pages.',
        parameters: {}
    },
    goToSlide: {
        description: 'Go to a specific slide number in the presentation. Only works on presentation pages.',
        parameters: {
            slideNumber: {
                type: 'number',
                description: 'The slide number to go to (1-based index, starting from 1)'
            }
        }
    }
} as const;
