  ...
  return (
    ...
    >
      ...
      <div
        ...
        } motion-preset-slide-up-right max-w-[70%] rounded-lg px-4 py-2`}
      >
...
export default function Transcriber({ conversation }: TranscriberProps) {
  ...
  return (
    <div className="bg-background dark:bg-background mx-auto flex h-full w-full flex-col overflow-hidden rounded-lg shadow-lg">
      {/* Header */}
      <div className="bg-secondary dark:bg-secondary flex items-center justify-between px-4 py-3">
      ...
      <div
        ref={scrollRef}
        className="scrollbar-thin scrollbar-thumb-primary z-50 h-full flex-1 space-y-4 overflow-y-auto p-4"
      >
        <AnimatePresence>
...
export { Avatar, AvatarImage, AvatarFallback, Transcriber }
